...
@WebService(name = "DavcnaBlagajna",
  serviceName = "DavcnaBlagajnaService",
...
public class DavcnaBlagajnaService {
    ...
    public String novRacun(@WebParam(name = "davcnaSt") String davcnaSt,
    ...
    public String novPoslovniProstor(@WebParam(name = "ppId")String ppId,
